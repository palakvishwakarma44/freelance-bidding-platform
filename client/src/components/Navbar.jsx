                    ...
                    {isMobileMenuOpen && (
                        <>
                            ...
                            <motion.div
                                ...
                                className="fixed top-0 right-0 h-full w-[300px] bg-[#111827] border-l border-white/10 z-40 p-6 pt-24 shadow-2xl xl:hidden overflow-y-auto"
                            >
                                <div className="space-y-2">
                                    ...
                                    {user ? (
                                        ...
                                        <div className="space-y-3 mt-4">
                                            <Link to="/login" className="block w-full text-center py-3 rounded-xl border border-white/10 text-white hover:bg-white/5">
                                                Log In
                                            </Link>
                                            <Link to="/register" className="block w-full text-center py-3 rounded-xl bg-primary text-white font-bold hover:bg-primary/90">
                                                Sign Up Free
                                            </Link>
                                        </div>
                                    )}
